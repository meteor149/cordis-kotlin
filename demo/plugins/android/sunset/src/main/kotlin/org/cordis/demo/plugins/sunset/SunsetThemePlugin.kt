...
class SunsetThemePlugin : Plugin<Unit>, PluginSurface {
    ...
    override fun surfaceInfo() = PluginSurfaceInfo(
        title = "Sunset private implementation",
        body = SunsetSupport.message(),
        provenance = "Private class packaged inside sunset.apk",
    )
...
private object SunsetSupport {
    fun message() = "The host can see PluginSurface, but it cannot import this helper class."
}
